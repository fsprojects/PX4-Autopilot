...
\title{Formal Verification of a UAV Flight Controller's Core Libraries with Lean~4:\\
       730 Theorems, Six Bugs, Zero Sorry in 51 Modules}
...
(no Mathlib), we verified \textbf{730~theorems} fully across \textbf{51~Lean modules}
...
\begin{itemize}
  \item A formal verification campaign covering \textbf{50+~C++ targets with Lean proofs}
        in 51~Lean modules, yielding \textbf{730~fully proved theorems} with
...
\textbf{730~theorems} are stated and proved with zero \texttt{sorry} in any proof
...
\begin{table}[t]
\centering
\caption{Lean 4 verification summary by file (51 files, 51+ C++ targets).
...
\hline
\textbf{Total}         &                                    & \textbf{730} & \textbf{0 sorry, 10 axioms} \\
\bottomrule
\end{tabular}
\end{table}
...
Across 51~files, roughly 50\% of theorems were proved by \texttt{decide} or
...
730~theorems covering rate limiting, interpolation, filtering, statistics, data
